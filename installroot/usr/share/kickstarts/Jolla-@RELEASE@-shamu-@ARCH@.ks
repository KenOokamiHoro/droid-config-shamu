# DisplayName: Jolla shamu/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-shamu-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration shamu
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/shamu
